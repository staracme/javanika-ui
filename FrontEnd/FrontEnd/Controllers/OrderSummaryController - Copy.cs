    ...
    public class OrderSummaryController : Controller
    {
        ...
        public JsonResult PlaceOrder(PaymentResponse response)
        {
            ...
            try
            {
                ...
                qrCodeImage.Save(QRCodePath + orderID.ToString() + ".png");
                ...
                //Convert.ToString(System.Configuration.ConfigurationManager.AppSettings["TemplatePath"]);
                ...
                #region Moved to SetEmailContent method
                ...
                #region Code moved to SendEmail Class
                ...
                //Convert.ToString(System.Configuration.ConfigurationManager.AppSettings["ReceiptTemplatePath"]);
                #region code moved to SetReceiptEmail method
                ...
                //MailMessage message1 = new MailMessage(username, order.Email, 
                //    "Your Receipt", receipt);
                //message1.IsBodyHtml = true;
                //smtp.Send(message1);

                //MailMessage message2 = new MailMessage(username, "javanikabooking@gmail.com"
                //    , "New Order", receipt);
                ...
                //if (evt.EventID == 3039)
                //{
                    if (order.NoOfTickets <= evt.TicketStock)
                    {
                        //Recheck this logic with omkar
                        evt.TicketStock = (evt.TicketStock - order.NoOfTickets);
                        db.SaveChanges();
                    }
                //}
        ...
        {
            SMTPEmailRequest smtpRequest = new SMTPEmailRequest();
            var order = db.tblTicketOrders.Where(t => t.OrderID == orderID).SingleOrDefault();
            var evt = db.tblEvents.Where(e => e.EventID == order.EventID).SingleOrDefault();
            ...
            smtpRequest.IsBodyHtml = true;
            SendEmail.SMTPEmail(smtpRequest);
        }
        ...
        private void SetReceiptEmail(int orderID)
        {
            ...
            //Receipt
            smtpRequest.CustomerName = username;
            smtpRequest.CustomerEmail = order.Email;
            ...
            smtpRequest1.CustomerName = username;
            smtpRequest1.CustomerEmail = "javanikabooking@gmail.com";
            smtpRequest1.MailTitle = "New Order";
            smtpRequest1.MailBody = receipt;
            smtpRequest1.IsBodyHtml = true;
            SendEmail.SMTPEmail(smtpRequest1);
